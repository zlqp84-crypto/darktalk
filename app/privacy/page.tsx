...
const sections = [
  ...
  {
    title: "5. 익명 게시물의 처리",
    content: `DarkTalk의 모든 게시물은 다른 이용자에게 익명으로 표시됩니다.\n\n• 게시물 작성 시 작성자 계정 정보가 함께 저장되며, 화면에는 실명 대신 익명으로 표시됩니다\n• 해당 계정 정보는 서비스 운영·부정 이용 방지 목적으로 열람될 수 있습니다\n• 법원의 영장 등 적법한 절차에 따른 요청이 있는 경우, 관련 법률에 따라 최소한의 정보를 수사기관에 제공할 수 있습니다`,
  },
  {
    title: "6. 이용자의 권리",
